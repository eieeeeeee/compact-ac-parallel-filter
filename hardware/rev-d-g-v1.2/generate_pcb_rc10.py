...
BOARD_FILE=ROOT/"RevD_G_v1_2_PCB_RC10.kicad_pcb"
...
# The entire +5V/VOS network is left to the multilayer router.  Previous RCs proved
# that manually fixing this feedback/output path creates crossings or isolated stubs.
...
text("Rev.D-G v1.2 PCB RC10 - LOW VOLTAGE ONLY",50,82,1.3)
text("U6 RAR0017B DRAFT - RC10 routing proof only; TI official land pattern freeze pending",50,79.5,0.9)
...
PRO_FILE=ROOT/"RevD_G_v1_2_PCB_RC10.kicad_pro"

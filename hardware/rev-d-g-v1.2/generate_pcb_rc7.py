...
BOARD_FILE=ROOT/"RevD_G_v1_2_PCB_RC7.kicad_pcb"
...
# RC7 board outline 120 x 85 mm. Size is intentionally relaxed until routing is proven.
...
text("Rev.D-G v1.2 PCB RC7 - LOW VOLTAGE ONLY",50,82,1.3)
text("U6 RAR0017B DRAFT - RC7 routing proof only; TI official land pattern freeze pending",50,79.5,0.9)
...
# Create an RC7 project alongside the board so kicad-cli DRC uses the intended rules.
PRO_FILE=ROOT/"RevD_G_v1_2_PCB_RC7.kicad_pro"

...
BOARD_FILE=ROOT/"RevD_G_v1_2_PCB_RC5.kicad_pcb"
...
# RC5 board outline 120 x 85 mm. Size is intentionally relaxed until routing is proven.
...
# Buck output/VOS connection left explicit because RC4 router left a 1-pad stub.
locked_direct("+5V",("L801","2"),("U7","6"),0.35)
...
text("Rev.D-G v1.2 PCB RC5 - LOW VOLTAGE ONLY",50,82,1.3)
text("U6 RAR0017B DRAFT - RC5 routing proof only; TI official land pattern freeze pending",50,79.5,0.9)
...
# Create an RC5 project alongside the board so kicad-cli DRC uses the intended rules.
PRO_FILE=ROOT/"RevD_G_v1_2_PCB_RC5.kicad_pro"

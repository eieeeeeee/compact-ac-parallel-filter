...
BOARD_FILE=ROOT/"RevD_G_v1_2_PCB_RC11.kicad_pcb"
...
locked_direct("+5V",("U7","6"),("L801","2"),0.20)
...
text("Rev.D-G v1.2 PCB RC11 - LOW VOLTAGE ONLY",50,82,1.3)
text("U6 RAR0017B DRAFT - RC11 routing proof only; TI official land pattern freeze pending",50,79.5,0.9)
...
PRO_FILE=ROOT/"RevD_G_v1_2_PCB_RC11.kicad_pro"

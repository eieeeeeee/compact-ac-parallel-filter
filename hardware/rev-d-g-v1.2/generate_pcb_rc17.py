...
BOARD_FILE=ROOT/"RevD_G_v1_2_PCB_RC17.kicad_pcb"
...
# U6: RC17 fabrication-candidate copper geometry for TI RAR0017B.
# Coordinates are transcribed from TI package drawing 4229681/B (03/2024)
# and cross-checked against independent public KiCad implementations.
# This removes the RC16 equal-pad DRAFT geometry.  Thermal vias remain omitted
# intentionally because TI marks them optional and via-in-pad requires a
# filled/plugged/tented process when used under paste.
(CUSTOM/"TI_RAR0017B_LMG2100_RC17.kicad_mod").write_text(r'''(footprint "TI_RAR0017B_LMG2100_RC17"
  (version 20240108) (generator pcbnew)
  (layer "F.Cu")
  (descr "LMG2100R044 TI RAR0017B land pattern; TI 4229681/B 03/2024; RC17 geometry freeze candidate")
  (attr smd)
  (fp_rect (start -2.25 -2.75) (end 2.25 2.75)
  ...
  (pad "3" smd roundrect (at -2.10 -1.325) (size 0.70 0.25)
    (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.20))
  (pad "4" smd roundrect (at -2.10 -0.825) (size 0.70 0.25)
    (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.20))
  (pad "8" smd roundrect (at 2.10 -0.825) (size 0.70 0.25)
    (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.20))
  (pad "9" smd roundrect (at 2.10 -1.325) (size 0.70 0.25)
    (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.20))
  (pad "10" smd roundrect (at 2.10 -1.825) (size 0.70 0.25)
    (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.20))
  (pad "12" smd roundrect (at 0.825 -2.60) (size 0.25 0.70)
    (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.20))
  (pad "13" smd roundrect (at 0.325 -2.60) (size 0.25 0.70)
    (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.20))
  (pad "14" smd roundrect (at -0.175 -2.60) (size 0.25 0.70)
    (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.20))
  (pad "15" smd roundrect (at -0.675 -2.60) (size 0.25 0.70)
    (layers "F.Cu" "F.Paste" "F.Mask") (roundrect_rratio 0.20))
  ...
  (pad "1" smd custom (at -2.10 -2.325) (size 0.01 0.01)
    ...
    (primitives (gr_poly
      (pts (xy 0.35 -0.125) (xy 0.35 -0.625) (xy 0.10 -0.625)
           (xy 0.10 -0.125) (xy -0.35 -0.125) (xy -0.35 0.125)
           (xy 0.35 0.125))
      (width 0) (fill yes))))
  (pad "11" smd custom (at 2.10 -2.325) (size 0.01 0.01)
    (layers "F.Cu" "F.Paste" "F.Mask")
    (options (clearance outline) (anchor rect))
    (primitives (gr_poly
      (pts (xy -0.35 -0.625) (xy -0.35 0.125) (xy 0.35 0.125)
  ...
  (pad "17" smd custom (at -0.225 -1.29) (size 0.01 0.01)
    ...
    (options (clearance outline) (anchor rect))
    (primitives (gr_poly
      (pts (xy 1.175 0.665) (xy -0.725 0.665) (xy -0.725 0.555)
           (xy -1.175 0.555) (xy -1.175 -0.665) (xy 1.175 -0.665))
      (width 0) (fill yes))))
  (pad "5" smd custom (at -2.10 1.35) (size 0.01 0.01)
    (layers "F.Cu" "F.Paste" "F.Mask")
    (options (clearance outline) (anchor rect))
    (primitives (gr_poly
      (pts (xy 0.35 -0.89) (xy 0.35 -1.25) (xy -0.025 -1.25)
           (xy -0.025 -0.89) (xy -0.35 -0.89) (xy -0.35 -0.64)
           (xy -0.025 -0.64) (xy -0.025 -0.39) (xy -0.35 -0.39)
           (xy -0.35 -0.14) (xy -0.025 -0.14) (xy -0.025 0.11)
           (xy -0.35 0.11) (xy -0.35 0.36) (xy -0.025 0.36)
           (xy -0.025 0.61) (xy -0.35 0.61) (xy -0.35 0.86)
           (xy -0.025 0.86) (xy -0.025 1.24) (xy 0.35 1.24))
      (width 0) (fill yes))))
  (pad "6" smd custom (at 0 1.175) (size 0.01 0.01)
    (layers "F.Cu" "F.Paste" "F.Mask")
    (options (clearance outline) (anchor rect))
    (primitives (gr_poly
      (pts (xy -0.95 -1.45) (xy -0.95 1.45) (xy -0.80 1.45)
           (xy -0.80 1.775) (xy -0.55 1.775) (xy -0.55 1.45)
           (xy -0.30 1.45) (xy -0.30 1.775) (xy -0.05 1.775)
           (xy -0.05 1.45) (xy 0.20 1.45) (xy 0.20 1.775)
           (xy 0.45 1.775) (xy 0.45 1.45) (xy 0.95 1.45)
           (xy 0.95 -1.45))
      (width 0) (fill yes))))
  (pad "7" smd custom (at 2.10 1.35) (size 0.01 0.01)
    (layers "F.Cu" "F.Paste" "F.Mask")
    (options (clearance outline) (anchor rect))
    (primitives (gr_poly
      (pts (xy -0.35 0.86) (xy -0.35 1.24) (xy 0.025 1.24)
           (xy 0.025 0.86) (xy 0.35 0.86) (xy 0.35 0.61)
           (xy 0.025 0.61) (xy 0.025 0.36) (xy 0.35 0.36)
           (xy 0.35 0.11) (xy 0.025 0.11) (xy 0.025 -0.14)
           (xy 0.35 -0.14) (xy 0.35 -0.39) (xy 0.025 -0.39)
           (xy 0.025 -0.64) (xy 0.35 -0.64) (xy 0.35 -0.89)
           (xy 0.025 -0.89) (xy 0.025 -1.25) (xy -0.35 -1.25))
      (width 0) (fill yes))))
)''',encoding="utf-8")
...
override={
    ...
    "U6":"RevDG:TI_RAR0017B_LMG2100_RC17",
...
"R601":(70,22.0,180),"R602":(70,16.0,180),"R603":(90.0,33.1,0),"R604":(87.0,33.1,0),
"C601":(91.0,35.93,90),"C602":(87.55,34.15,0),"C603":(89.75,33.7,0),"C604":(89.55,40.7,180),"C605":(89.55,42.7,180),"C606":(92.0,41.7,180),
...
text("Rev.D-G v1.2 PCB RC17 - LOW VOLTAGE ONLY",50,82,1.3)
text("U6 RAR0017B TI geometry - RC17 copper/mask freeze candidate; stencil aperture audit pending",50,79.5,0.9)
...
PRO_FILE=ROOT/"RevD_G_v1_2_PCB_RC17.kicad_pro"

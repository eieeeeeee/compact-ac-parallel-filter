...
BOARD_FILE=ROOT/"RevD_G_v1_2_PCB_RC6.kicad_pcb"
...
# RC6 board outline 120 x 85 mm. Size is intentionally relaxed until routing is proven.
...
"L801":(108,12,0),"C801":(108,22,0),"C802":(114,22,0),"C803":(108,18,0),"C804":(113,18,0),"R805":(100,6,0),
...
# Buck local loop: SW -> L801 -> +5V, with local VOS feedback.
locked_direct("BUCK_SW",("U7","7"),("L801","1"),0.30)
locked_direct("+5V",("L801","2"),("U7","6"),0.30)
...
text("Rev.D-G v1.2 PCB RC6 - LOW VOLTAGE ONLY",50,82,1.3)
text("U6 RAR0017B DRAFT - RC6 routing proof only; TI official land pattern freeze pending",50,79.5,0.9)
...
# Create an RC6 project alongside the board so kicad-cli DRC uses the intended rules.
PRO_FILE=ROOT/"RevD_G_v1_2_PCB_RC6.kicad_pro"

...
BOARD_FILE=ROOT/"RevD_G_v1_2_PCB_RC18_COST_MAX_S1.kicad_pcb"
...
# U6: RC18 fabrication-candidate copper geometry for TI RAR0017B.
...
(CUSTOM/"TI_RAR0017B_LMG2100_RC18.kicad_mod").write_text(r'''(footprint "TI_RAR0017B_LMG2100_RC18"
  (version 20240108) (generator pcbnew)
  (layer "F.Cu")
  (descr "LMG2100R044 TI RAR0017B land pattern; TI 4229681/B 03/2024; RC18 geometry freeze candidate")
  (attr smd)
...
override={
    ...
    "U6":"RevDG:TI_RAR0017B_LMG2100_RC18",
...
# Create an RC18 Stage-1 project alongside the board so kicad-cli DRC uses the intended rules.
PRO_FILE=ROOT/"RevD_G_v1_2_PCB_RC18_COST_MAX_S1.kicad_pro"

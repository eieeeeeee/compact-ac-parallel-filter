...
BOARD_FILE=ROOT/"RevD_G_v1_2_PCB_RC4.kicad_pcb"
...
# RC4 board outline 120 x 85 mm. Size is intentionally relaxed until routing is proven.
...
"C301":(50,40,180),"R301":(38.5,40,180),"R302":(28.5,40,0),"R303":(36,46,0),"C303":(41,46,0),"C304":(35,50,0),
...
"R601":(66,20.5,180),"R602":(66,17.5,180),"R603":(91,34,0),"R604":(91,43,0),
...
"TP1":(15,70,0),"TP2":(8,41,0),"TP3":(39,51,0),"TP4":(61,65,0),"TP5":(82,38,0),
...
locked_direct("HRTIM_HI_RAW",("U1","42"),("R601","1"),0.20)
locked_direct("HRTIM_LI_RAW",("U1","43"),("R602","1"),0.20)
...
text("Rev.D-G v1.2 PCB RC4 - LOW VOLTAGE ONLY",50,82,1.3)
text("U6 RAR0017B DRAFT - RC4 routing proof only; TI official land pattern freeze pending",50,79.5,0.9)
...
# Create an RC4 project alongside the board so kicad-cli DRC uses the intended rules.
PRO_FILE=ROOT/"RevD_G_v1_2_PCB_RC4.kicad_pro"

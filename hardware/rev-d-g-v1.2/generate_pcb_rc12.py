...
BOARD_FILE=ROOT/"RevD_G_v1_2_PCB_RC12.kicad_pcb"
...
_vos_a=v(104.60,14.00)
_vos_b=v(109.00,14.00)
locked_track("+5V",_u7_vos,_vos_a,0.20)
locked_track("+5V",_vos_a,_vos_b,0.20)
locked_track("+5V",_vos_b,_l801_out,0.20)
...
text("Rev.D-G v1.2 PCB RC12 - LOW VOLTAGE ONLY",50,82,1.3)
text("U6 RAR0017B DRAFT - RC12 routing proof only; TI official land pattern freeze pending",50,79.5,0.9)
...
PRO_FILE=ROOT/"RevD_G_v1_2_PCB_RC12.kicad_pro"

...
"U1":(58,20,0),"U2":(18,21,0),"U3":(47.5,45,0),"U4":(53,54,0),"U5":(61,54,0),
"U6":(94,40,0),"U7":(103,12,0),"U8":(83,12,0),"K1":(34,55,0),"Q1":(43,55,0),"Q2":(47,55,0),
"FB101":(40,34,0),
...
"C301":(62.5,40,180),"R301":(54,40,180),"R302":(47,40,0),"R303":(55,47,0),"C303":(59,47,0),"C304":(52,48,0),
...
"R601":(68,18.5,0),"R602":(68,21.5,0),"R603":(97,36.5,0),"R604":(97,43.5,0),
"C601":(98,40,0),"C602":(99,33,0),"C603":(103,33,0),"C604":(90,33,0),"C605":(94,33,0),"C606":(98,30,0),
"L601":(86,40,180),"C611":(81.5,44,0),"L602":(77,40,180),"C612":(72.5,44,0),"L603":(68,40,180),"C613":(64,44,0),
"R701":(39,61,0),"R702":(44,61,0),"D701":(34,61,0),
"L801":(96,12,0),"C801":(108,22,0),"C802":(114,22,0),"C803":(93,20,0),"C804":(98,20,0),"R805":(100,6,0),
"C901":(78,7,0),"C902":(83,19,0),"C903":(87,24,0),
"TP1":(15,66,0),"TP2":(8,41,0),"TP3":(52,51,0),"TP4":(65,62,0),"TP5":(89,40,0),
"TP6":(61,36,0),"TP7":(91,12,0),"TP8":(75,20,0),"TP9":(28,21,0),"TP10":(5,41,0)
}
...
def locked_branch(netname,a,xy,width=0.25,layer=pcbnew.F_Cu):
    return locked_track(netname,pad(*a).GetPosition(),v(*xy),width,layer)

# LC ladder: short, wide, single-layer links.  U6->L601 remains autorouted until the
# final TI RAR0017B land pattern replaces the integration draft.
locked_direct("GAN_F1",("L601","2"),("L602","1"),0.60)
locked_branch("GAN_F1",("C611","1"),(81.50,40.00),0.50)
locked_direct("GAN_F2",("L602","2"),("L603","1"),0.60)
locked_branch("GAN_F2",("C612","1"),(72.50,40.00),0.50)
locked_direct("ACTIVE_OUT",("L603","2"),("C301","1"),0.60)
locked_branch("ACTIVE_OUT",("C613","1"),(64.00,40.00),0.50)
...
# HRTIM source-termination resistors close to MCU pins.

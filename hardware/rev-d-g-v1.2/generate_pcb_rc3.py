...
BOARD_FILE=ROOT/"RevD_G_v1_2_PCB_RC3.kicad_pcb"
...
# RC3 board outline 120 x 85 mm. Size is intentionally relaxed until routing is proven.
...
P={
"J1":(6,66,0),"J2":(114,12,0),"J3":(27,8,90),
"U1":(58,20,0),"U2":(18,21,0),"U3":(36,48,0),"U4":(52,52,0),"U5":(60,52,0),
"U6":(90,40,0),"U7":(103,12,0),"U8":(83,12,0),"K1":(27,55,0),"Q1":(38,55,0),"Q2":(42,55,0),
"FB101":(40,34,0),
...
"C301":(51.5,40,180),"R301":(42,40,180),"R302":(34.5,40,0),"R303":(43,44.5,0),"C303":(47,44.5,0),"C304":(41.5,48,0),
"R401":(56,58,0),"R402":(61,58,0),"R403":(66,58,0),"R404":(71,58,0),"R405":(76,58,0),"C405":(80,58,0),"C406":(84,58,0),
"C501":(10,46,0),"R501":(22,46,0),"C502":(10,52,0),"R502":(22,52,0),"C503":(10,58,0),"R503":(22,58,0),
"R601":(68,18.5,0),"R602":(68,21.5,0),"R603":(93,36.5,0),"R604":(93,43.5,0),
"C601":(94,40,0),"C602":(95,33,0),"C603":(99,33,0),"C604":(86,33,0),"C605":(90,33,0),"C606":(94,30,0),
"L601":(81,40,180),"C611":(81,45.5,0),"L602":(71,40,180),"C612":(71,45.5,0),"L603":(61,40,180),"C613":(61,45.5,0),
"R701":(35,64,0),"R702":(40,64,0),"D701":(27,64,0),
"L801":(96,12,0),"C801":(108,22,0),"C802":(114,22,0),"C803":(93,20,0),"C804":(98,20,0),"R805":(100,6,0),
"C901":(78,7,0),"C902":(83,19,0),"C903":(87,24,0),
"TP1":(15,66,0),"TP2":(8,41,0),"TP3":(44,51,0),"TP4":(65,62,0),"TP5":(90,48,0),
"TP6":(56,34,0),"TP7":(91,12,0),"TP8":(75,20,0),"TP9":(28,21,0),"TP10":(5,41,0)
}
...
# GaN switch node and bootstrap: short, wide, top-layer only.
locked_direct("GAN_SW",("U6","5"),("L601","1"),0.80)
locked_direct("GAN_SW",("U6","11"),("L601","1"),0.80)
locked_direct("GAN_SW",("C601","2"),("U6","11"),0.50)
locked_direct("GAN_HB",("C601","1"),("U6","10"),0.25)

# Three-section reconstruction ladder.
locked_direct("GAN_F1",("L601","2"),("L602","1"),0.60)
locked_direct("GAN_F1",("C611","1"),("L601","2"),0.50)
locked_direct("GAN_F2",("L602","2"),("L603","1"),0.60)
locked_direct("GAN_F2",("C612","1"),("L602","2"),0.50)
locked_direct("ACTIVE_OUT",("L603","2"),("C301","1"),0.60)
locked_direct("ACTIVE_OUT",("C613","1"),("L603","2"),0.50)

# Physical injection path.
locked_direct("INJ_C_NODE",("C301","2"),("R301","1"),0.80)
locked_direct("INJ_R_NODE",("R301","2"),("R302","2"),0.80)

# Kelvin sense: dedicated short traces from the shunt pads to INA240 inputs.
locked_direct("INJ_R_NODE",("R302","2"),("U3","8"),0.20)
locked_direct("INJ_LINE",("R302","1"),("U3","1"),0.20)

# HRTIM source termination and post-resistor logic traces: top layer, no vias.
locked_direct("HRTIM_HI_RAW",("U1","42"),("R601","1"),0.25)
locked_direct("HRTIM_LI_RAW",("U1","43"),("R602","1"),0.25)
locked_direct("GAN_HI",("R601","2"),("U6","12"),0.25)
locked_direct("GAN_LI",("R602","2"),("U6","13"),0.25)
...
text("Rev.D-G v1.2 PCB RC3 - LOW VOLTAGE ONLY",50,82,1.3)
...
# Create an RC3 project alongside the board so kicad-cli DRC uses the intended rules.
PRO_FILE=ROOT/"RevD_G_v1_2_PCB_RC3.kicad_pro"

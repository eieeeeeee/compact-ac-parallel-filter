# KiCad 9 hardware — Rev.A 32 × 28 mm pre-prototype

This directory contains an **editable KiCad 9 project** for the first compact layout study.
...
1. Open/save in KiCad 9 and run ERC/DRC.
2. Apply the final mains creepage/clearance rules for the actual regulatory environment.
3. Verify enclosure and component maximum dimensions.
4. Select exact 1206 resistor part numbers and verify working/pulse voltage, power and flame behavior.
5. Select exact LED and diode parts.
6. Replace J1 with the final plug/enclosure mechanical interface.
7. Review fuse/MOV coordination.
...
C2 and optional RC damping are intentionally **not implemented on this 32 × 28 mm Rev.A PCB**. They remain measurement-driven future variants.
